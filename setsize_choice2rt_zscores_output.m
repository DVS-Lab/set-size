...
myFiles = dir(maindir,output_z_scores,'*_task_b_results_z_scores.csv');
...
for s = 1:length(myFiles)   
    ...
    % write data to output file 'setsize_choice2rt_output.tsv'
